...
contract ETERNITY is Context, IERC20, Ownable {
    ...
    address private constant BUSD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD
    ...
    function setWallets(address _donation, address _dev) external onlyOwner {
        _donationAddress = _donation;
        _devAddress = _dev;
    }
    ...
    function _transfer(
     ...
     function swapAndDistribute(uint256 tokens) private {
        ...
        swapAndSendDividends(
            newBalance.mul(rewardsFee).div(10 ** 2)
        );
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("ETERNITY_Dividend_Tracker", "ETERNITY_Dividend_Tracker")
    {
        claimWait = 3600;
